...
END IF
					...
					'???????????
					YXTH="<p style='text-indent: 2em; text-align: justify; line-height: 1.5em; margin-bottom: 5px; margin-top: 5px;'>    <span style='color: rgb(0, 0, 0); font-family: ?????????, 'Microsoft YaHei';'><font size='+16'>"
					YXTHJW = "</font></span></p>"
					XTH="<p style='text-indent: 2em; text-align: justify; line-height: 1.5em; margin-bottom: 5px; margin-top: 5px;'>    <span style='color: rgb(0, 0, 0); font-family: ?????????, 'Microsoft YaHei';'>"
					XTHJW = "</span></p>"
					...
					'????????
					 ...
					 s_info_desc=replace(s_info_desc,"#SPW#","'>???????????????????</a>")
					 ...
					 s_info_descn=replace(s_info_descn,"#SPW#","'>???????????????????</a>")
...
<body bgcolor="white">
<div align="center"><font color="#0000FF" class="main">????????????????????????????????????????? </font></div>
<hr>
<form method="POST" action="article_main.asp" name="un" >
  <table width="580" border="0" bordercolordark="#99CCFF" bordercolorlight="#99CCFF" cellspacing="1" align="center" cellpadding="6" bgcolor="#000000">
   ...
   <tr bgcolor="#FFFFFF"> 
	 ...
	 <td width="32%" class="main">????????:</td>
      <td width="68%" class="main"> 
      <a href="http://zhanzhang.baidu.com/linksubmit/url" target='_blank'>??????????????</a> ?????????????????????????????
