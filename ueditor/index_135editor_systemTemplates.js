$(function () {
    ...
    $("[href='#systemTemplates']").click(function () {
        ...
        if (!$.trim($("#systemTemplates").html())) {
            ...
            $.get(url).then(function (data) {
                templateCache = cacheTemplatesInfo(data); //??????ß÷?template????????
    ...
    function popupTemplateOptions() {
        ...
        //????? ?????????icon ???????
        var icon_miaoshua = $("<span class='glyphicon glyphicon-edit' aria-hidden='true'>√ÎÀ¢</span>")
        var icon_charu = $("<span class='glyphicon glyphicon-log-in' aria-hidden='true'>≤Â»Î</span>")
